...
def enrich_bronze_record(record: dict) -> dict:
    """
    Thêm metadata của bước ghi Bronze.

    Không xóa metadata từ crawler.
    Metadata crawler được giữ trong metadata.upstream_metadata.
    """
    ...
    try:
        ...
        while _running:
            for msg in consumer:
                ...
                # Nếu sang ngày mới thì flush buffer ngày cũ
                ...
                # Chỉ flush khi đủ số record/file
